...
// ==================== CORE ENTITIES ====================
// Primary business objects that everything else references
...
export interface Project {
  ...
  // Additional fields your API uses
  scopeOfWork?: string;
  products?: string;
  pipelineId?: string;
  pipelineName?: string;
  
  // GHL sync fields (from ACTUAL)
...
// ==================== QUOTES & FINANCIAL ====================
// Quote creation, signatures, and payment tracking
...
export interface Appointment {
  ...
  duration: number;
  timezone: string;
  locationType: string; // 'address', 'custom', 'phone', 'video', etc.
  customLocation: string;
  address: string;
  meetingUrl?: string;
  status: string; // 'scheduled', 'completed', 'cancelled', 'no_show', 'rescheduled'
  appointmentStatus: string; // 'confirmed', 'unconfirmed', 'cancelled'
  contactName: string;
  contactEmail: string;
  contactPhone: string;
  calendarName: string;
...
// ==================== COMMUNICATION ====================
// Messages, conversations, and notes
...
// ==================== PROJECT MANAGEMENT ====================
// Tasks, milestones, and project tracking
...
// Templates, libraries, tags, and system configuration
...
// Company/Agency and Location management
...
// ==================== FILE STORAGE (GridFS) ====================
// File metadata for PDFs and images stored in GridFS
...
export interface PaymentProofFile {
  ...
  chunkSize: number;
  uploadDate: string;
  filename: string; // 'payment_{paymentId}_proof_{timestamp}.jpg'
  metadata: {
    paymentId: string;
    locationId: string;
    uploadedAt: string;
