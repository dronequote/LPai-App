...
export default function BulkSmsModal({ 
 ...
 const sendBulkSms = async () => {
   ...
   setSending(true);
   try {
     const contactObjectIds = selectedContacts.map(c => c._id);  // Changed from contactIds
     const result = await smsService.sendBatch(contactObjectIds, message.trim());  // Now passes contactObjectIds
